...
void PagesTextEdit::setPageOrientation(const QPrinter::Orientation _orientation)
{
    m_pageMetrics.update(m_pageMetrics.pageFormat(), m_pageMetrics.mmPageMargins() ,_orientation);
