...
void PageMetrics::update(QPageSize::PageSizeId _pageFormat, QMarginsF _mmPageMargins, QPrinter::Orientation _orientation)
{
    ...
    {
        m_pxPageSize =
                    QSizeF(mmToPx(m_mmPageSize.height(), x),
                           mmToPx(m_mmPageSize.width(), y));
    }
	m_pxPageMargins =
...
QPrinter::Orientation PageMetrics::orientation() const
{
